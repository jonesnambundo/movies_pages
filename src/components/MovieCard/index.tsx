...
export default function MovieCard({ movie, onDetails }: MovieCardProps) {
  ...
  const isFav = isFavorited(movie.id, "movie"); // fixado como "movie"
  ...
  return (
    <div className="min-w-[160px] sm:min-w-[180px] md:min-w-[200px] lg:min-w-[220px] xl:min-w-[240px] snap-start">
      ...
      <div className="px-1 pt-3">
        <h3 className="text-neutral-400 text-sm font-medium truncate">
          {movie.title}
        </h3>
        <div className="flex items-center justify-between mt-2">
          ...
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className={`h-4 w-4 ${
                isFav ? "text-red-500 fill-current" : "text-purple-600"
              }`}
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
