...
interface MovieCardProps {
  movie: Movie;
  onDetails?: () => void;                 // <- sem parâmetro, o card já sabe o id
  mediaType?: "movie" | "tv";             // <- permite TV também; default "movie"
}

export default function MovieCard({ movie, onDetails, mediaType = "movie" }: MovieCardProps) {
  ...
  return (
    <div className="min-w-[160px] sm:min-w-[180px] md:min-w-[200px] lg:min-w-[220px] xl:min-w-[240px] snap-start">
      ...
      <div className="px-1 pt-3">
        <h3 className="text-neutral-200 text-sm font-medium line-clamp-2">
          {movie.title}
        </h3>
        <div className="flex items-center justify-between mt-2">
          ...
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className={`h-4 w-4 ${isFav ? "text-red-500" : "text-purple-500"}`}
              viewBox="0 0 24 24"
